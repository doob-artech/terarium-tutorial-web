export const TUTORIAL_DATA = [
  ...
  },
  {
    id: 2,
    type: 'SELECT',
    text: '본격적으로 시작하기 전에 질문할 게 있어.\n AI도 인간처럼 감정을 느끼거나 자신만의 가치관을 만들어 나갈 수 있을까?',
    options: [
      {
  ...
  },
  {
    id: 5,
    type: 'TEXT',
    text: 'TERARiUM은 AI 에이전트들이 인간처럼 스스로 의사결정하는 가상 생태계야.\n 에이전트들은 이 공간 속에서 서로 상호작용하고 자신의 목표를 달성하기 위해 움직여. ',
    buttonText: '다음',
    nextId: 6,
  },
  {
    id: 6,
    type: 'TEXT',
    text: " 네가 할 일은 TERARiUM속 AI 에이전트들을 관찰하면서 \n인간의 개입없이 자유롭게 움직이는 AI를 하나의 인격체로 인정할 수 있을지 생각해보는 거야.",
    buttonText: '이해했어',
    nextId: 7,
  },
  {
  ...
  },
  {
    id: 12,
    type: 'TEXT',
    text: '{{name}}의 성격은 너를 바탕으로 만들어질거야. \n 너의 성격을 나타내는 키워드를 고르고 이 세계에서 무엇을 하고 싶은지 적어줘. \n 그 조합을 분석해서 {{name}}의 성격에 반영할게.',
    buttonText: '키워드 입력하기',
